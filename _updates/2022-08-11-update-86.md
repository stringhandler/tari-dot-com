...
> NOTE: `Esmeralda` testnet will have a **genesis block starting 15 August 2022**, but will most likely be reset a number of times as we add features, so if you are looking for stability, rather use `dibbler`. 
